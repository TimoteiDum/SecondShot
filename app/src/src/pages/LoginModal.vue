<template>
  <div>
    ...
    <h2
      class="text-2xl font-extrabold mb-6 text-center bg-clip-text text-transparent"
      style="background-image: linear-gradient(90deg, #7c3aed, #06b6d4)"
    >
      Log In
    </h2>
    <form @submit.prevent="handleLogin" class="flex flex-col gap-4">
      ...
      <button
        ...
        :class="
          isLoginDisabled
            ...
            : 'bg-gradient-to-tr from-indigo-600 to-sky-500 text-white hover:from-indigo-700 hover:to-sky-600'
        "
      >
        Log In
      </button>
      <p class="mt-2 text-center">
        <router-link
          ...
          style="color: rgba(199, 179, 255, 0.95)"
        >
          Forgot password?
        </router-link>
      </p>
