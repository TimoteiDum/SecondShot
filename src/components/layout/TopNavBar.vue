<template>
  ...
  <div class="relative">
          ...
          <span v-if="cart.totalItems > 0" class="absolute -top-1 -right-1 bg-red-600 text-white text-sm w-6 h-6 rounded-full flex items-center justify-center">{{ cart.totalItems }}</span>
          </router-link>
