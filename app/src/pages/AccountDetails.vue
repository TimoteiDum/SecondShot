  ...
  <div class="min-h-screen flex items-start justify-center pt-24 px-4">
    <div class="w-full max-w-2xl bg-white/95 rounded-xl shadow p-6">
      ...
      <form @submit.prevent="save">
        ...
        <input
          v-model="form.name"
          class="w-full mt-1 mb-4 p-2 border rounded"
        ...
        <div class="flex gap-3">
          ...
          <router-link to="/profile" class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300"
            >Back</router-link
          >
        </div>
      </form>
...
<script setup>
defineOptions({ name: 'AccountDetailsPage' })
