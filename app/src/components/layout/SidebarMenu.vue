<template>
  <transition name="fade">
    <aside v-if="show" class="fixed inset-0 z-60 flex" @click.self="$emit('close')">
      <transition name="slide">
        <div v-show="show" class="panel w-72 md:w-80 lg:w-96 h-full flex flex-col">
          <div class="panel-inner px-6 py-5 flex items-center justify-between">
            ...
            <button @click="$emit('close')" class="text-2xl text-white/80 hover:text-white">
              &times;
            </button>
          </div>
          ...
          <nav class="flex-1 px-4 py-6">
            <ul class="space-y-3">
              <li>
                ...
                >
                  <span
                    class="w-8 h-8 rounded-md bg-gradient-to-tr from-orange-400 to-red-500 flex items-center justify-center text-white"
                  >
              ...
              <li>
                ...
                >
                  <span
                    class="w-8 h-8 rounded-md bg-gradient-to-tr from-sky-400 to-indigo-600 flex items-center justify-center text-white"
                  >
              ...
              <li>
                ...
                >
                  <span
                    class="w-8 h-8 rounded-md bg-gradient-to-tr from-amber-400 to-orange-500 flex items-center justify-center text-white"
                  >
